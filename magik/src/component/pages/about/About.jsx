...
const About = () => {
  ...
  const teamData = teamMembers.map((member, index) => ({
    ...
    image: `https://magikworld.com${member.image}`, // Replace with your actual domain
  }));
  ...
  return (
    <>
      <Helmet>
        <title>    At Magikworld01 we belive that every moment, big or small, deserves to be
          celebrated. </title>
        <script type="application/ld+json">{JSON.stringify(teamData)}</script>
      </Helmet>
